...
| Arguments | Explanation                                                                                                  | Required |
| --------- | ------------------------------------------------------------------------------------------------------------ | -------- |
| `--mode`  | Edit an entry from the`cats` table or the `log` table<br /><br />Accepted arguments: `cat, cats, log, logs ` | YES      |
...
| Arguments | Explanation                                                                                                    | Required |
| --------- | -------------------------------------------------------------------------------------------------------------- | -------- |
| `--mode`  | Delete an entry from the`cats` table or the `log` table<br /><br />Accepted arguments: `cat, cats, log, logs ` | YES      |
